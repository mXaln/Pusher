...
public class Main extends Application {
    ...
    private final ObservableList<Person> data
            = FXCollections.observableArrayList(
            new Person("Jacob", typeData.get(0), new Date()),
            new Person("Urs", typeData.get(1), new Date()),
            new Person("Hans", typeData.get(2), new Date()),
            new Person("Ueli", typeData.get(2), new Date()));
    ...
    public void start(Stage stage) {
        ...
        Callback<TableColumn<Person, Type>, TableCell<Person, Type>> comboBoxCellFactory
                = (TableColumn<Person, Type> param) -> new ComboBoxEditingCell();

        TableColumn<Person, String> firstNameCol = getPersonStringTableColumn(cellFactory);

        TableColumn<Person, Type> lastNameCol = getPersonTypeTableColumn(comboBoxCellFactory);

        TableColumn<Person, Date> emailCol = getPersonDateTableColumn(dateCellFactory);
    ...
    @NotNull
    private static TableColumn<Person, Date> getPersonDateTableColumn(Callback<TableColumn<Person, Date>, TableCell<Person, Date>> dateCellFactory) {
    ...
    @NotNull
    private static TableColumn<Person, Type> getPersonTypeTableColumn(Callback<TableColumn<Person, Type>, TableCell<Person, Type>> comboBoxCellFactory) {
        TableColumn<Person, Type> lastNameCol = new TableColumn<>("Lieblings Tier");
        ...
        lastNameCol.setOnEditCommit(
                (TableColumn.CellEditEvent<Person, Type> t) -> {
                    ((Person) t.getTableView().getItems()
                            .get(t.getTablePosition().getRow()))
    ...
    @NotNull
    private static TableColumn<Person, String> getPersonStringTableColumn(Callback<TableColumn<Person, String>, TableCell<Person, String>> cellFactory) {
...
//            });
    ...
    class ComboBoxEditingCell extends TableCell<Person, Type> {
        ...
        private void createComboBox() {
            comboBox = new ComboBox<>(typeData);
...
//            });
        ...
        private void comboBoxConverter(ComboBox<Type> comboBox) {
        ...
        private Type getTyp() {
            return getItem() == null ? new Type("") : getItem();
        }
    }
    ...
    public static class Person {
        ...
        private final SimpleObjectProperty<Type> typ;
        private final SimpleObjectProperty<Date> birthday;

        public Person(String firstName, Type type, Date bithday) {
            this.firstName = new SimpleStringProperty(firstName);
            this.typ = new SimpleObjectProperty(type);
        ...
        public Type getTypObj() {
            return typ.get();
        }

        public ObjectProperty<Type> typObjProperty() {
            return this.typ;
        }

        public void setTypObj(Type type) {
            this.typ.set(type);
        }
